    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">Shubharambh Event Management</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm text-gray-500">Email: admin@shubharambh.com</p>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500">
            © 2025 Shubharambh Event & Management. All rights reserved.
          </p>
        </div>
      </div>
    </div>
